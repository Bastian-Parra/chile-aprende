  ...
  return (
    <section className="w-full flex justify-between gap-10">
      <div className="flex flex-col gap-5 w-1/2">
        ...
        <h3 className="text-xl text-primarygreen bg-yellow-50 rounded-md w-4/5">
          Aprende la Historia y Geografía de Chile a través de desafíos, juegos
          y misiones emocionantes.
        </h3>
        <SignedOut>
      ...
      <div
        className="w-1/2 rounded-2xl p-0 shadow-md"
        style={{
